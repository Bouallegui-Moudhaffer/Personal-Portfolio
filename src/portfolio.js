...
const experience = {
  ...
  sections: [
    ...
    },
    {
      ...
      experiences: [
        {
          title: "IEEE Power & Energy Society Chapter Vice Chairman",
          company: "Bauddhik-Geeks",
          company_url: "https://www.ieee.org",
          logo_path: "icon-ieee.png",
          duration: "December 2021 - April 2022",
          location: "University Campus",
          description:
            "My job of as IEEE PES chapter vice chairman was to assist the chapter chairman in organizing meetings and events, recruitment of new members, preparing reports, nominating for awards, supporting student activities, and other duties as assigned.",
          color: "#FBBD18",
        },
        {
          title: "DeepFlow Active Member",
          company: "DeepFlow",
          company_url: "https://www.linkedin.com/company/deepflowesprit/",
          logo_path: "deepflow.png",
